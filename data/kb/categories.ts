...
export const CATEGORIES: Category[] = [
  ...
  { slug: 'telecom', name: 'Telecom (mobile/broadband)', root: 'Housing', leaf: 'Telecom', sort: 32 },
  ...
  { slug: 'jewellery', name: 'Jewellery', root: 'Shopping', leaf: 'Jewellery', sort: 52 },
  ...
  { slug: 'government', name: 'Government & tax', root: 'Financial', leaf: 'Government', sort: 92 },
  { slug: 'fees', name: 'Fees & charges', root: 'Financial', leaf: 'Fees', sort: 93 },
